...
export const THREADS_ARCHIVE_VIDEO: Media = {
    title: 'Threads 1984',
    duration: 6749600,
    sources: ['https://archive.org/download/threads_201712/threads.mp4'],
};

export const PRISONER_ARCHIVE_VIDEO: Media = {
    title: 'The Prisoner 01 Arrival',
    duration: 2935410,
    sources: ['https://archive.org/download/The_Prisoner/ThePrisoner01Arrival.mp4'],
};

export const BAD_DURATION_ARCHIVE_MUSIC: Media = {
    title: 'Ike Stubblefield',
    duration: 498000,
    sources: ['https://archive.org/download/blr2020-05-01/bobby2020-05-01d01t01.mp3'],
};
